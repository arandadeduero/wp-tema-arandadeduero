			...
			<div class="container mt-1">
				<div class="row justify-content-center">
					<div class="p-0 col-6 text-center">
						<button id="moreEspecial" class="more-especial col-8 p-0 mx-auto"><p class="mb-0 py-2">Más especiales</button>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-12">
					<div class="footer-links d-flex flex-lg-row flex-column justify-content-between mt-4">
						<div class="footer-images ">
							...
							<!-- <img class="img img-fluid mr-4" src="/wp-content/uploads/2021/04/europeanwine.png" alt="Aranda del Duero Ciudad del vino"> -->
						</div>
						<div id="footer-social" class="text-right d-flex flex-column justify-content-end col-sm-12 col-md-12 col-lg-6 col-xl-6">
							...
							<div class="footer-social-icons">
								...
								<!-- <a href="http://blog.arandadeduero.es/" rel="external" target="_blank"><span class="d-none">Blog</span><i class="fab fa-blogger ml-2 fa-2x"></i></a>-->
							</div>
						</div>
					</div>
				</div>
